...
account_password = '$!z2BX.9#?e5b!h'  # your indeed password
job_titles = ['python']  # separate job titles must be in quotations separated by a comma
job_location = '30340'  # job zip

# apply personal answers
apply_linkedin = 'www.linkedin.com'
apply_personalwebsite = 'mohamedmaache.eu'
